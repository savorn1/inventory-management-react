...
const variantCls: Record<Variant, string> = {
  ...
  cancel:  'bg-slate-100 hover:bg-slate-200 text-slate-600 border border-slate-200',
...
export function AppButton({ variant = 'primary', size = 'md', className = '', children, ...props }: Props) {
  return (
    <button
      {...props}
