...
export function ClientView() {
  ...
  return (
    <div className="p-4 md:p-7 flex flex-col gap-5">
          ...
          store.loading ? (
            ...
            store.items.map((item, idx) => (
              ...
              >
                ...
                <td className="px-4 py-3 text-slate-500 whitespace-nowrap capitalize">
                  {item.gender || "—"}
                </td>
      ...
      <AppModal
        show={showModal}
        title={editingId ? t("client.editTitle") : t("client.addTitle")}
        onClose={closeModal}
      >
        <form
