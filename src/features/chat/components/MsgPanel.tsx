...
export function MsgPanel({
  ...
  const convName = resolveConvName(
    conversation,
    convMembers,
    userMap,
    currentUserId,
      ...
      <div className="flex flex-col flex-1 min-w-0 h-full">
        ...
        <div className="flex items-center gap-3 px-5 py-3 border-b border-slate-100 bg-white shrink-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div
              className={`text-[11px] font-medium ${connected ? "text-green-500" : "text-slate-400"}`}
            >
              <span
                className={`inline-block w-1.5 h-1.5 rounded-full mr-1 ${connected ? "bg-green-500" : "bg-slate-300"}`}
              />
